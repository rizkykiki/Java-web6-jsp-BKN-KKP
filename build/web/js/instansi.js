$(function () {
    ...
    var instansi2Array = $.map(instansi2, function (value, key) { return { value: value, data: key }; });
    ...
    $.mockjax({
        ...
        response: function (settings) {
            var query = settings.data.query,
                ...
                suggestions = $.grep(instansi2Array, function (instansi2) {
                     // return country.value.toLowerCase().indexOf(queryLowerCase) === 0;
                    return re.test(instansi2.value);
                }),
                response = {
                    query: query,
    ...
    $('#autocomplete-custom-append4').autocomplete({
        lookup: instansi2Array,
