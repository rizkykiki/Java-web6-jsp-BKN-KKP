$(function () {
    ...
    var jurusanArray = $.map(jurusan, function (value, key) { return { value: value, data: key }; });
    ...
    $.mockjax({
        ...
        response: function (settings) {
            var query = settings.data.query,
                ...
                suggestions = $.grep(jurusanArray, function (jurusan) {
                     // return country.value.toLowerCase().indexOf(queryLowerCase) === 0;
                    return re.test(jurusan.value);
                }),
                response = {
                    query: query,
 ...
 $('#autocomplete-ajax').autocomplete({
    ...
    $('#autocomplete-custom-appendd1').autocomplete({
        lookup: jurusanArray,
