$(function () {
    ...
    var pendidikanArray = $.map(pendidikan, function (value, key) { return { value: value, data: key }; });
    ...
    $.mockjax({
        ...
        response: function (settings) {
            var query = settings.data.query,
                ...
                suggestions = $.grep(pendidikanArray, function (pendidikan) {
                     // return country.value.toLowerCase().indexOf(queryLowerCase) === 0;
                    return re.test(pendidikan.value);
                }),
                response = {
                    query: query,
 ...
 $('#autocomplete-ajax').autocomplete({
    ...
    $('#autocomplete-custom-appendd').autocomplete({
        lookup: pendidikanArray,
